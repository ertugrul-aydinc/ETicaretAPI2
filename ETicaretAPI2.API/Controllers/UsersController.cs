...
using ETicaretAPI2.Application.Features.Commands.AppUser.AssignRoleToUser;
...
using ETicaretAPI2.Application.Features.Queries.AppUser.GetAllUsers;
using ETicaretAPI2.Application.Features.Queries.AppUser.GetRolesToUser;
using MediatR;
...
namespace ETicaretAPI2.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        [AuthorizeDefiniton(ActionType =ActionType.Reading, Definition ="Get All Users", Menu ="Users")]
        ...
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefiniton(ActionType = ActionType.Reading, Definition = "Get Roles To User", Menu = "Users")]
        ...
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefiniton(ActionType = ActionType.Reading, Definition = "Assign Role To User", Menu = "Users")]
