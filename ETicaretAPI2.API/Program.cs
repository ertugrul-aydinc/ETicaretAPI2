...
builder.Services.AddHttpContextAccessor();//Client'tan gelen request neticesinde oluþturulan http context nesnesine katmanlardaki classlar üzerinden eriþebilmemizi saðlayan bir servistir.
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer("Admin",options =>
    {
        options.TokenValidationParameters = new()
        {
            ...
            NameClaimType = ClaimTypes.Name //JWT üzerinde name claimine karþýlýk gelen user.identity.name propertysinden elde edebiliriz.
        };
    });
