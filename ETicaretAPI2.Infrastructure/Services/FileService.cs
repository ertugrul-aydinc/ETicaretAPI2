using ETicaretAPI2.Application.Services;
using ETicaretAPI2.Infrastructure.Operations;
...
namespace ETicaretAPI2.Infrastructure.Services
{
    public class FileService : IFileService
    {
        ...
        public async Task<List<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
        {
            ...
            return null;
            //todo Yukarıdaki if geçerli değilse burada bir hata alınıdığına dair exception gerekiyor.
        }
    }
}
